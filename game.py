...
class Game:
    ...
    def auto_move(self):
        ...
        strategy = get_move(self.level.structure[:-1], self.level.position_player, 'astar', manhattanDistance)
        strategy = get_move(self.level.structure[:-1], self.level.position_player, 'astar', diagonalDistance)
        strategy = get_move(self.level.structure[:-1], self.level.position_player, 'astar', euclideanDistance)
